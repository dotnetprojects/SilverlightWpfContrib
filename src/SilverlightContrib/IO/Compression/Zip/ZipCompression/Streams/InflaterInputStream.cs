...
namespace SilverlightContrib.IO.Compression.Zip.ZipCompression.Streams
{
	...
	/// as the <see cref="SilverlightContrib.IO.Compression.Zip.ZipInputStream">ZipInputStream</see>.
	///
