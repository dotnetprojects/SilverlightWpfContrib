...
using SilverlightContrib.IO.Compression.Zip.Encryption;
#endif

using SilverlightContrib.IO.Compression.Zip.Core;
using SilverlightContrib.IO.Compression.Zip.Checksums;
using SilverlightContrib.IO.Compression.Zip.ZipCompression.Streams;
using SilverlightContrib.IO.Compression.Zip.ZipCompression;
using System.Collections.Generic;

namespace SilverlightContrib.IO.Compression.Zip
{
	...
	public class ZipFile : IEnumerable, IDisposable
	{
		...
		/// </exception>
        /// <exception cref="SilverlightContrib.IO.Compression.Zip.ZipException">
